...
namespace App\Http\Controllers\Admin\Product\Perfumeries;
...
class PerfumeriesController extends Controller
{
    ...
    public function showProductForm () 
    {
        ...
        return view('admin.product.perfumeries.new_product', ['top_category' => $top_category, 'data' => $all_sub_category, 'brand' => $all_brand]);
    }
    ...
    {
        return view('admin.product.perfumeries.product_list.product_list');
    }
        ...
        if(!empty($product_data)) {
            ...
            foreach ($product_data as $single_data) {
                ...
                if($single_data->status == 1)
                    $val = "<a href=\"".route('admin.change_perfumeries_product_status', ['product_id' => encrypt($single_data->id), 'status' => encrypt(0)])."\" class=\"btn btn-primary\">In-Active</a>";
                else
                    $val = "<a href=\"".route('admin.change_perfumeries_product_status', ['product_id' => encrypt($single_data->id), 'status' => encrypt(1)])."\" class=\"btn btn-primary\">Active</a>";
                ...
                $nestedData['product_banner']  = "&emsp;<a href=\"".route('admin.edit_perfumeries_product_banner', ['product_id' => encrypt($single_data->id)])."\" class=\"btn btn-success\" target=\"_blank\">Change Banner</a>";

                $nestedData['product_images']  = "&emsp;<a href=\"".route('admin.additional_perfumeries_product_image_list', ['product_id' => encrypt($single_data->id)])."\" class=\"btn btn-primary\" target=\"_blank\">Product Images List</a>";

                $nestedData['action']  = "&emsp;<a href=\"".route('admin.view_perfumeries_product', ['product_id' => encrypt($single_data->id)])."\" class=\"btn btn-success\" target=\"_blank\">View</a>&emsp;<a href=\"".route('admin.edit_perfumeries_product', ['product_id' => encrypt($single_data->id)])."\" class=\"btn btn-warning\" target=\"_blank\">Edit</a>&emsp;$val";
    ...
    public function showEditProductBanner($product_id)
    {
        ...
        return view('admin.product.perfumeries.banner.edit_banner' , ['url' => $url, 'product_id' => $product_id]);
    }
    ...
    public function viewProduct($product_id)
    {
        ...
        return view('admin.product.perfumeries.action.view_product', ['product_record' => $product_record]);
    }
    ...
    public function showEditProduct ($product_id) 
    {
        ...
        return view('admin.product.perfumeries.action.edit_product', ['all_top_category' => $all_top_category, 'brand' => $all_brand, 'all_sub_category' => $all_sub_category, 'product_record' => $product_record, 'all_third_level_sub_category' => $all_third_level_sub_category]);
    }
