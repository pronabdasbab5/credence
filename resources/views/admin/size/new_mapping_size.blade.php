      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.add_mappping_size') }}" class="form-horizontal form-label-left">
                @csrf
                        ...
                        @if (count($all_mapping_size) > 0)
                            ...
                            @foreach ($all_mapping_size as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->size }}</td>
                                    <td>
                                        <a href="{{ route('admin.edit_mappping_size', ['size_mapping_id' => encrypt($item->id)]) }}" class="btn btn-warning form-text-element">Edit</a>
                                    </td>
                                </tr> 
                            @endforeach
                        @endif
