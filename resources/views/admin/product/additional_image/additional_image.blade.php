                                    ...
                                    <div class="well profile_view">
                                      <div class="col-sm-12">
                                        <div class="left col-xs-7">
                                            <img src="{{ asset('assets/product_images/'.$value->additional_image) }}" style="width: 290px;" id="img">
                                        </div>
                                      </div>
                                      <div class="col-xs-12 bottom text-center">
                                        <form method="POST" autocomplete="off" action="{{ route('admin.update_product_additional_image', ['additional_image_id' => $value->id]) }}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
