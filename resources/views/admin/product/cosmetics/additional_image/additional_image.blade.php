                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                                    <div class="well profile_view">
                                      ...
                                      <div class="col-xs-12 bottom text-center">
                                        <form method="POST" autocomplete="off" action="{{ route('admin.update_cosmetics_product_additional_image', ['additional_image_id' => encrypt($value->id) ]) }}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
