      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.update_perfumeries_product', ['product_id' => encrypt($product_record[0]->id) ]) }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="well" style="overflow: auto">
                    ...
                    <div class="form-row mb-3">
                        <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                            ...
                            <input type="number" min="1" class="form-control form-text-element" name="stock" required value="{{ $product_record[0]->stock }}">
                            </select>
                            @error('stock')
                                {{ $message }}
                            @enderror
