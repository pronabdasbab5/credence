      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content"><br />
            ...
            <form method="POST" autocomplete="off" action="{{ route('admin.update_third_level_sub_category', ['subCategoryId' => encrypt($third_level_sub_category->id)]) }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    ...
                    <div class="form-row mb-3">
                            ...
                            <select class="form-control form-text-element" name="top_cate_name" id="top_cate_name" required>
                                ...
                                @if(count($top_categories) > 0)
                                    @foreach($top_categories as $key => $value)
                                        @if($value->id == $third_level_sub_category->top_category)
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                            ...
                            <select class="form-control form-text-element" name="sub_cate_name" id="sub_cate_name" required>
                                ...
                                @if(count($sub_categories) > 0)
                                    @foreach($sub_categories as $key => $value)
                                        @if($value->id == $third_level_sub_category->sub_category)
                         ...
                         <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                            ...
                            <input type="text" name="third_level_sub_cate_name" id="third_level_sub_cate_name" class="form-control col-md-7 col-xs-12 form-text-element" value="{{ $third_level_sub_category->third_level_sub_category_name }}" required>
